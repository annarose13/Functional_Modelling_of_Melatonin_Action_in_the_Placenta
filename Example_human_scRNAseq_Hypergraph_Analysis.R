...
write.csv(CTB_1_CONTROL_result_df, "~/RP2/Yang/Yang_Hypernetwork_Analysis/CTB_1/CTB_1_CONTROL_entropy_results.csv", row.names=FALSE)
...
write.csv(CTB_1_CONTROL_entropy_results, "~/RP2/Yang/Yang_Hypernetwork_Analysis/CTB_1/CTB_1_CONTROL_entropy_results.csv", row.names=FALSE)
...
write.csv(CTB_2_CONTROL_result_df, "~/RP2/Yang/Yang_Hypernetwork_Analysis/CTB_2/CTB_2_CONTROL_entropy_results.csv", row.names=FALSE)
...
# Overwrite results file:
write.csv(CTB_2_CONTROL_entropy_results, "~/RP2/Yang/Yang_Hypernetwork_Analysis/CTB_2/CTB_2_CONTROL_entropy_results.csv", row.names=FALSE)
...
write.csv(CTB_3_CONTROL_result_df, "~/RP2/Yang/Yang_Hypernetwork_Analysis/CTB_3/CTB_3_CONTROL_entropy_results.csv", row.names=FALSE)
...
# Overwrite results file:
write.csv(CTB_3_CONTROL_entropy_results, "~/RP2/Yang/Yang_Hypernetwork_Analysis/CTB_3/CTB_3_CONTROL_entropy_results.csv", row.names=FALSE)
...
write.csv(CTB_4_CONTROL_result_df, "~/RP2/Yang/Yang_Hypernetwork_Analysis/CTB_4/CTB_4_CONTROL_entropy_results.csv", row.names=FALSE)
...
# Overwrite results file:
write.csv(CTB_4_CONTROL_entropy_results, "~/RP2/Yang/Yang_Hypernetwork_Analysis/CTB_4/CTB_4_CONTROL_entropy_results.csv", row.names=FALSE)
...
write.csv(STB_1_CONTROL_result_df, "~/RP2/Yang/Yang_Hypernetwork_Analysis/STB_1/STB_1_CONTROL_entropy_results.csv", row.names=FALSE)
...
# Overwrite results file:
write.csv(STB_1_CONTROL_entropy_results, "~/RP2/Yang/Yang_Hypernetwork_Analysis/STB_1/STB_1_CONTROL_entropy_results.csv", row.names=FALSE)
